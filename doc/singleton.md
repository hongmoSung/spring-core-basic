...
**인스턴스가 같은지 테스트 결과**
```shell
memberService -> memberRepo1 = hello.core.member.MemoryMemberRepository@2584b82d
orderService -> memberRepo2 = hello.core.member.MemoryMemberRepository@7bbc8656
memberRepository = hello.core.member.MemoryMemberRepository@6933b6c6
```  
