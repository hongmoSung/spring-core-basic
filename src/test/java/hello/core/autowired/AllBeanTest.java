...
public class AllBeanTest {
    ...
    void findAllBean() {
        ...
        final int fixDiscountPrice = discountService.discount(userA, 10000, "fixDiscountPolicy");

        assertThat(discountService).isInstanceOf(DiscountService.class);
        assertThat(fixDiscountPrice).isEqualTo(1000);

        final int rateDiscountPrice = discountService.discount(userA, 20000, "rateDiscountPolicy");
    ...
    static class DiscountService {
        ...
        public int discount(Member member, int price, String discountCode) {
            final DiscountPolicy policy = policyMap.get(discountCode);
